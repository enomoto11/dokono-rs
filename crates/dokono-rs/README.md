...
`dokono-rs` is one of several CLIs in this workspace; its analysis machinery is shared with sibling tools via the internal [`dokono-core`](../dokono-core/) library. See the [workspace README](../../README.md) for the full lineup.
...
cd dokono-rs
cargo build --release -p dokono-rs
